...
public class gramaticaParser extends Parser {
	...
	public static final int
		...
		EQUAL_EQUAL=30, RETURN=31, ID=32, CTE_INT=33, CTE_FLOAT=34, LETRERO=35, 
		WS=36;
	public static final int
		...
		RULE_termino = 13, RULE_exp = 14, RULE_cte = 15, RULE_retorno = 16;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RETURN", "ID", "CTE_INT", "CTE_FLOAT", "LETRERO", "WS"
		};
	}
	...
	public final CuerpoContext cuerpo() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6443500928L) != 0)) {
				{
				{
				setState(58);
				estatuto();
	...
	public final LlamadaContext llamada() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30077419520L) != 0)) {
				{
				setState(176);
				expresion();
				setState(181);
